	...
	<form action="regquery.php" method="post" onsubmit="return validate();" >
		<center>
			<div ><h1>Registration </h1><br>
				...
				Confirm Password:<input type="password" name="cpass" id="cpass" placeholder="Enter your password again"><br>
				...
				Select image:<input type="file" name="img" id="img" accept="image/*"><br>
